...
class GironimoCalendar(HTMLCalendar):
    ...
    def __init__(self):
        """ Retrieve and convert the localized first week day at 
        initialization """
        HTMLCalendar.__init__(self, AMERICAN_TO_EUROPEAN_WEEK_DAYS[
            get_format('FIRST_DAY_OF_WEEK')])
    
    def formatday(self, day, weekday):
        """ Return a day as a table cell with a link if entries are published 
        this day """
    ...
    def formatweekheader(self):
        ...
        return '<thead>%s</thead>' % super(
            GironimoCalendar, self).formatweekheader()
    ...
    def formatmonth(self, theyear, themonth, withyear=True,
        ...
        formatting a day, and thead/tfooter """

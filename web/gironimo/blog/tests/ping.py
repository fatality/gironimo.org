...
from gironimo.blog.ping import URLRessources
...
class ExternalUrlsPingerTestCase(TestCase):
    ...
    def test_find_external_urls(self):
        ...
        self.entry.content = """
        <p>This is a <a href="http://gironimo.org.willbreak.it/">link</a>
        to a site.</p>
        ...
        self.entry.save()
        external_urls = self.pinger.find_external_urls(self.entry)
        self.assertEquals(external_urls, ['http://gironimo.org.willbreak.it/'])
    ...
    def test_find_pingback_urls(self):
        ...
        self.original_urlopen = gironimo.blog.ping.urlopen
        gironimo.blog.ping.urlopen = self.fake_urlopen
        ...
        # Remove stub
        gironimo.blog.ping.urlopen = self.original_urlopen

...
from gironimo.blog.config import MAIL_COMMENT_REPLY
from gironimo.blog.config import MAIL_COMMENT_AUTHORS
from gironimo.blog.config import AUTO_MODERATE_COMMENTS
from gironimo.blog.config import AUTO_CLOSE_COMMENTS_AFTER
from gironimo.blog.config import MAIL_COMMENT_NOTIFICATION_RECIPIENTS
...
class EntryCommentModerator(CommentModerator):
    ...
    def moderate(self, comment, content_object, request):
        ...
        allowed to show up immediately, or should be marked non-public and await 
        approval."""

...
from gironimo.blog.config import MARKUP_LANGUAGE
from gironimo.blog.config import ENTRY_TEMPLATES
from gironimo.blog.config import ENTRY_BASE_MODEL
from gironimo.blog.config import MARKDOWN_EXTENSIONS
...
def get_base_model():
    """ Determine the base Model to inherit in the Entry Model, this allow to 
    overload it. """
...
post_save.connect(ping_external_urls_handler,
                  sender=Entry, dispatch_uid=
                  'gironimo.blog.entry.post_save.ping_external_urls')

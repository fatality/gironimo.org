...
def disconnect_blog_signals():
    ...
    post_save.disconnect(sender=Entry, dispatch_uid='gironimo.blog.entry.post_save.ping_directories')
    post_save.disconnect(sender=Entry, dispatch_uid='gironimo.blog.entry.post_save.ping_external_urls')

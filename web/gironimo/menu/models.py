...
class MenuItem(StatMixin, models.Model):
    ...
    menu = models.ForeignKey(
        ...
        verbose_name=ugettext_lazy(u'Menü'), 
        null=True, 
        blank=True, 
        editable=False
    )
    ...
    def save(self, force_insert=False, **kwargs):
        from gironimo.menu.utils import clean_ranks
...
class Menu(models.Model):
    ...
    class Meta:
        verbose_name = _(u'Menü')
        verbose_name_plural = _(u'Menüs')
